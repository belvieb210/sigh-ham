...
import { mettreAJourCompteMedecinExterneClient } from "@/lib/client/gestion-comptes-partenaires";
...
export async function PUT(request: NextRequest, ctx: Ctx) {
  ...
  try {
    ...
    const compte = await mettreAJourCompteMedecinExterneClient(id, {
      ...
      numeroOrdre: body.numeroOrdre != null ? String(body.numeroOrdre) : undefined,
      statut:
    ...
    console.error("[PUT /api/client/comptes-medecins-externes/[id]]", error);
