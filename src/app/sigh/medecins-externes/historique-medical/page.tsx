...
import { ContenuHistoriqueMedecinsExternes } from "@/features/medecins-externes/contenu-historique-medecins-externes";
...
export const metadata: Metadata = {
  title: "Historique médical — Médecins externes",
...
export default async function Page() {
  ...
  return (
    <ContenuHistoriqueMedecinsExternes
