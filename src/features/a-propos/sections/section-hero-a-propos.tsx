...
export function SectionHeroAPropos() {
  ...
  const images = (hero.imagesFond ?? []).filter(
    (i) => i.url && !i.url.startsWith("/images/")
  );
    ...
    >
      <div className="absolute inset-0" aria-hidden="true">
        {imageCourante ? (
          ...
          <div className="absolute inset-0 bg-gradient-to-br from-[#0f172a] via-[#2d2a6e] to-[#1a4d7c]" />
        )}
          ...
          >
            <div className="rounded-2xl border border-white/15 bg-white/10 p-5 backdrop-blur-md">
              <p className="text-[10px] font-bold uppercase tracking-wider text-[#7dd3fc]">
                {imageCourante?.alt || "HAM Laboratoire"}
              </p>
