...
export function SectionImpactAPropos() {
  const { impact } = useContenuAPropos();

  return (
    <section
      className="section-impact-a-propos bg-white py-12 sm:py-16 lg:py-20"
      aria-labelledby="titre-impact-a-propos"
    >
