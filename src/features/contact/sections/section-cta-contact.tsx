...
export function SectionCtaContact() {
  const { cta } = useContenuContact();

  return (
    <section aria-label="Appel à l'action contact">
        ...
        <div className="conteneur-principal relative">
          ...
          >
            ...
            <div className="flex flex-col gap-3 sm:flex-row lg:flex-col xl:flex-row">
              <Link href={cta.boutonRdv.href} className="flex-1">
                <Bouton
                  taille="grand"
                ...
                >
                  ...
                  {cta.boutonRdv.etiquette}
                  <ArrowRight className="h-4 w-4" />
                </Bouton>
              </Link>
              <a href={cta.boutonFormulaire.href} className="flex-1">
                <Bouton
                  taille="grand"
                  variante="contour"
                ...
                >
                  ...
                  {cta.boutonFormulaire.etiquette}
                </Bouton>
              </a>
            </div>
          </motion.div>
