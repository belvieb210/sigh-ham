...
import {
  PanneauExamensDisponiblesEglise,
  SectionsMobileExamensDisponiblesEglise,
} from "@/features/eglise/panneau-examens-disponibles-eglise";
...
const CLE = "eglise.examensDisponibles";

interface PropsContenuExamensDisponiblesEglise {
  utilisateur: UtilisateurEglise;
}

export function ContenuExamensDisponiblesEglise({
  utilisateur,
}: PropsContenuExamensDisponiblesEglise) {
  ...
  const exporterSelection = () => {
    ...
    telechargerCsv(
      `eglise-examens-disponibles-${new Date().toISOString().slice(0, 10)}.csv`,
  ...
  return (
    <MiseEnPageEglise
      ...
      panneauDroit={<PanneauExamensDisponiblesEglise {...propsPanneau} />}
    >
      <div className="mx-auto w-full max-w-[1280px] space-y-4">
        ...
        <BarreFiltresLaboratoire
          idPrefix="filtre-eglise-examens-disponibles"
        ...
        <SectionsMobileExamensDisponiblesEglise {...propsPanneau} />
      </div>
    </MiseEnPageEglise>
  );
}
