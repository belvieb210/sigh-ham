  ...
  return (
    <>
      <div className="flex items-start justify-between border-b border-gris-bordure px-4 py-4">
        ...
        {onFermer && (
          <button
            ...
            aria-label={t("eglise.layout.fermerMenu")}
          >
            <X className="h-5 w-5" />
          </button>
        )}
      ...
      <nav className="flex-1 overflow-y-auto px-3 py-4">
        {rendreSection(t("eglise.layout.sectionPrincipal"), principal)}
        {rendreSection(t("eglise.layout.sectionEglise"), eglise)}
        {rendreSection(t("eglise.layout.sectionCommunication"), communication)}
        {rendreSection(t("eglise.layout.sectionParametres"), parametres)}
      </nav>

      <div className="space-y-2 border-t border-gris-bordure p-3">
        <Link
          href="/sigh/eglise/profil"
          onClick={onFermer}
...
export function BarreLateraleEglise({
  utilisateur,
  ouvert = false,
  onFermer,
}: PropsBarreLaterale) {
    ...
    <header className="sticky top-0 z-30 shrink-0 border-b border-gris-bordure bg-white">
      <div className="flex items-center gap-1.5 px-2.5 py-2 sm:gap-2 sm:px-4 sm:py-2.5 lg:hidden">
        <button
          ...
          aria-label={t("eglise.layout.ouvrirMenu")}
        >
