...
interface PropsPanneauExamensDisponiblesEglise {
...
export function PanneauExamensDisponiblesEglise({
  patient,
...
}: PropsPanneauExamensDisponiblesEglise) {
  const { t } = useTranslation();

  const libelleImprimer =
    nbExamensSelectionnes > 0
      ? t("eglise.examensDisponibles.imprimerSelection", {
          count: nbExamensSelectionnes,
        })
      : t("eglise.examensDisponibles.imprimerTous");
  ...
  return (
    <aside className="flex w-full min-w-0 shrink-0 flex-col gap-4">
      ...
      <SectionExamensFacturePanneauCaisse
        ...
        prefixeApi="/api/eglise/examens-disponibles"
        prefixeCle="eglise.examensDisponibles"
      />
...
export function SectionsMobileExamensDisponiblesEglise(
  props: PropsPanneauExamensDisponiblesEglise
) {
  return (
    <div className="xl:hidden">
      <PanneauExamensDisponiblesEglise {...props} />
    </div>
  );
}
