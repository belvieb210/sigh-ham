            ...
            <table className="tableau-sigh">
              <thead className="border-b border-gris-bordure bg-gris-tres-clair/60 text-xs uppercase tracking-wide text-texte-secondaire">
                <tr>
                  ...
                  <th className="px-2 py-1.5">{t("medecinsExternes.patients.colonnes.ordre")}</th>
                  <th className="px-2 py-1.5">{t("medecinsExternes.patients.colonnes.patient")}</th>
                  <th className="px-2 py-1.5">{t("medecinsExternes.patients.colonnes.motif")}</th>
                  <th className="px-2 py-1.5">{t("medecinsExternes.patients.colonnes.provenance")}</th>
                  <th className="px-2 py-1.5">{t("medecinsExternes.patients.colonnes.orientation")}</th>
                  <th className="px-2 py-1.5">{t("medecinsExternes.patients.colonnes.statut")}</th>
                  <th className="px-2 py-1.5">{t("medecinsExternes.patients.colonnes.heure")}</th>
                  <th className="px-2 py-1.5">{t("medecinsExternes.patients.colonnes.actions")}</th>
                </tr>
              </thead>
              <tbody>
                {filtrés.map((p) => {
