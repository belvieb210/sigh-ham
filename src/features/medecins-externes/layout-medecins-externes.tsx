    ...
    <>
      <div className="flex items-start justify-between border-b border-gris-bordure px-4 py-4">
        <div className="min-w-0 flex-1">
          <LogoHam taille="petit" href="/sigh/medecins-externes" className="max-w-full" />
        ...
        {onFermer && (
          <button
            ...
            aria-label={t("medecinsExternes.layout.fermerMenu")}
          >
            <X className="h-5 w-5" />
          </button>
        )}
      ...
      <div className="space-y-2 border-t border-gris-bordure p-3">
        ...
        {onFermer && (
          ...
          >
            ...
            {t("medecinsExternes.layout.deconnecter")}
          </button>
        )}
      </div>
    </>
...
export function BarreLateraleMedecinsExternes({
  utilisateur,
  ouvert = false,
  onFermer,
}: PropsBarreLaterale) {
    ...
    <header className="sticky top-0 z-30 shrink-0 border-b border-gris-bordure bg-white">
      <div className="flex items-center gap-1.5 px-2.5 py-2 sm:gap-2 sm:px-4 sm:py-2.5 lg:hidden">
        <button
          ...
          aria-label={t("medecinsExternes.layout.ouvrirMenu")}
        >
