...
interface PropsOrientationRapideMedecinsExternes {
  orientation?: string;
...
export function OrientationRapideMedecinsExternes({
  ...
  return (
    <div className="space-y-2">
      {ORIENTATIONS_RAPIDES_MEDECINS_EXTERNES.map((opt) => {
          ...
          >
            ...
            <span className="min-w-0 flex-1">
              <span className="block">
                {t(`medecinsExternes.orientations.${opt.value}.label`, {
                  defaultValue: opt.label,
                })}
              </span>
              <span className="block text-xs font-normal text-texte-secondaire">
                {t(`medecinsExternes.orientations.${opt.value}.description`, {
