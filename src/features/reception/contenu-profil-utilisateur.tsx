...
import { MiseEnPageClient } from "@/features/client/mise-en-page-client";
      ...
      : salle === "laboratoire"
        ...
        : salle === "medecins"
          ...
          : salle === "infirmiers"
            ...
            : salle === "pharmacie"
              ? t("pharmacie.nav.profil")
              : salle === "medecins-externes"
                ? t("medecinsExternes.nav.profil")
                : salle === "eglise"
                  ? t("eglise.nav.profil")
                  : salle === "client"
                    ? t("client.nav.profil")
      ...
      : salle === "laboratoire"
        ...
        : salle === "medecins"
          ...
          : salle === "infirmiers"
            ...
            : salle === "pharmacie"
              ? t("pharmacie.layout.sousTitre")
              : salle === "medecins-externes"
                ? t("medecinsExternes.layout.sousTitre")
                : salle === "eglise"
                  ? t("eglise.layout.sousTitre")
                  : salle === "client"
                    ? t("client.layout.sousTitre")
      ...
      : salle === "laboratoire"
        ...
        : salle === "medecins"
          ...
          : salle === "infirmiers"
            ...
            : salle === "pharmacie"
              ? { label: t("pharmacie.layout.titre"), href: "/sigh/pharmacie" }
              : salle === "medecins-externes"
                ? {
                    label: t("medecinsExternes.layout.titre"),
                    href: "/sigh/medecins-externes",
                  }
                : salle === "eglise"
                  ? {
                      label: t("eglise.layout.titre"),
                      href: "/sigh/eglise",
                    }
                  : salle === "client"
                    ? {
                        label: t("client.layout.titre"),
                        href: "/sigh/client",
                      }
