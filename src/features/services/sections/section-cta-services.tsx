...
export function SectionCtaServices() {
  const { cta } = useContenuServices();

  return (
    <section className="section-cta-services" aria-label="Appel à l'action">
        ...
        <div className="conteneur-principal relative">
          ...
          >
            ...
            <div className="flex flex-col gap-3 sm:flex-row lg:flex-col xl:flex-row">
              <Link href={cta.boutonPrincipal.href} className="flex-1">
                <Bouton
                  taille="grand"
