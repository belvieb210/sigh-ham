...
export const laboratoireFr = {
  ...
  orientationsStatut: {
    ...
    VERIFIES: {
      label: "Validés",
      description: "Résultats techniques validés",
    },
    REJETES: {
      label: "Rejetés",
    ...
    DR_APPROUVE: {
      label: "Approuvés",
      description:
        "Résultats approuvés par le biologiste — restent visibles ici, même après sortie de file, un dossier / une facture par ligne",
    },
  },
  actions: {
  ...
  drApprouve: {
    developperExamens: "Afficher les examens Approuvés",
    replierExamens: "Masquer les examens Approuvés",
    examensTitre: "{{count}} examen(s) Approuvés",
    selectionnerTousExamens: "Sélectionner tous les examens Approuvés du patient",
