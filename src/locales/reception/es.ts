...
export const receptionEs = {
  ...
  panneau: {
    ...
    aideOrientationReception:
      "Marque una o varias salas de destino (Caja, Enfermería, Médico, Laboratorio, Farmacia, etc.).",
  ...
  orientations: {
    ...
    PHARMACIE: { label: "Farmacia", description: "Entrega de medicamentos" },
    HOSPITALISATION: { label: "Hospitalización", description: "Ingreso / camas" },
  },
  actions: {
    rechercherPatient: "Buscar paciente",
    estimations: "Estimations",
  ...
  formulaire: {
    ...
    visiteTerminee: "Terminada",
    visiteEnCoursAccueil: "En curso en recepción",
    visiteEnParcours: "En recorrido: {{salle}}",
    nouvelleVisiteAuto: "Se creará una nueva visita (VIS) al registrar.",
    reutiliseVisite: "Esta visita aún abierta en recepción continuará.",
    recherchePatient: {
  ...
  paquets: {
    titre: "Paquetes de exámenes (tarifa fija)",
    examensUnitaires: "Exámenes individuales",
    recherchePlaceholder: "Buscar un paquete (ej. prematrimonial)...",
    rechercheEnCours: "Buscando…",
    aucunResultat: "Ningún paquete coincide con su búsqueda.",
    catalogueVide: "No hay paquetes activos.",
    catalogueHint: "Elija un paquete a tarifa fija o exámenes individuales.",
    forfait: "Tarifa fija",
    countExamens: "{{count}} examen incluido",
    countExamens_plural: "{{count}} exámenes incluidos",
    selectionResume: "{{count}} línea seleccionada",
    selectionResume_plural: "{{count}} líneas seleccionadas",
    chargement: "No se pudieron cargar los paquetes.",
    indisponible: "Búsqueda de paquetes no disponible",
  },
  modales: {
