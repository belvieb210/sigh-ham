...
export const receptionFr = {
  ...
  formulaire: {
    ...
    visiteTerminee: "Terminée",
    visiteEnCoursAccueil: "En cours à l'accueil",
    visiteEnParcours: "En parcours : {{salle}}",
    nouvelleVisiteAuto:
      "Une nouvelle visite (VIS) et un nouveau PAT seront créés. L'ancienne visite continue son parcours.",
    reutiliseVisite: "Cette visite encore ouverte à l'accueil sera poursuivie.",
    recherchePatient: {
    ...
    champs: {
      numeroEnregistrement: "N° patient (permanent)",
      date: "Date",
      heure: "Heure",
  ...
  paquets: {
    ...
    selectionResume: "{{count}} ligne sélectionnée",
    selectionResume_plural: "{{count}} lignes sélectionnées",
    chargement: "Impossible de charger les paquets bilans.",
    indisponible: "Recherche paquets indisponible",
  },
  modales: {
    titre: "Examens initiaux",
  ...
  messagerie: {
    ...
    contenuTransfereIndisponible: "↪ Message transféré — contenu indisponible",
    demo: {
      receptionMatin:
