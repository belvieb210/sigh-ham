...
export const receptionHe = {
  ...
  panneau: {
    ...
    aideOrientationReception:
      "סמנו חדר יעד אחד או יותר (קופה, סיעוד, רופא, מעבדה, בית מרקחת וכו').",
  ...
  paquets: {
    titre: "חבילות בדיקות (מחיר קבוע)",
    examensUnitaires: "בדיקות בודדות",
    recherchePlaceholder: "חפש חבילה (למשל לפני נישואין)...",
    rechercheEnCours: "מחפש…",
    aucunResultat: "אין חבילה התואמת לחיפוש.",
    catalogueVide: "אין חבילות בדיקות פעילות.",
    catalogueHint: "בחר חבילה במחיר קבוע או בדיקות בודדות.",
    forfait: "מחיר קבוע",
    countExamens: "בדיקה {{count}} כלולה",
    countExamens_plural: "{{count}} בדיקות כלולות",
    selectionResume: "שורה {{count}} נבחרה",
    selectionResume_plural: "{{count}} שורות נבחרו",
    chargement: "לא ניתן לטעון חבילות.",
    indisponible: "חיפוש חבילות לא זמין",
  },
  modales: {
