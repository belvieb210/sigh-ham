...
export const receptionPt = {
  ...
  paquets: {
    titre: "Pacotes de exames (preço fixo)",
    examensUnitaires: "Exames individuais",
    recherchePlaceholder: "Pesquisar um pacote (ex. pré-nupcial)...",
    rechercheEnCours: "A pesquisar…",
    aucunResultat: "Nenhum pacote corresponde à sua pesquisa.",
    catalogueVide: "Nenhum pacote ativo.",
    catalogueHint: "Escolha um pacote fixo ou exames individuais.",
    forfait: "Preço fixo",
    countExamens: "{{count}} exame incluído",
    countExamens_plural: "{{count}} exames incluídos",
    selectionResume: "{{count}} linha selecionada",
    selectionResume_plural: "{{count}} linhas selecionadas",
    chargement: "Não foi possível carregar os pacotes.",
    indisponible: "Pesquisa de pacotes indisponível",
  },
  modales: {
