...
export const receptionZh = {
  ...
  paquets: {
    titre: "检验套餐（固定价格）",
    examensUnitaires: "单项检验",
    recherchePlaceholder: "搜索套餐（如婚前检验）...",
    rechercheEnCours: "搜索中…",
    aucunResultat: "没有匹配的套餐。",
    catalogueVide: "没有可用的检验套餐。",
    catalogueHint: "选择固定价格套餐或单项检验。",
    forfait: "固定价格",
    countExamens: "包含 {{count}} 项检验",
    countExamens_plural: "包含 {{count}} 项检验",
    selectionResume: "已选 {{count}} 行",
    selectionResume_plural: "已选 {{count}} 行",
    chargement: "无法加载检验套餐。",
    indisponible: "套餐搜索不可用",
  },
  modales: {
    titre: "初检项目",
    titrePatient: "患者检验",
